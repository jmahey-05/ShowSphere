import { LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusSquareIcon, CalendarIcon } from 'lucide-react'
...
const AdminSidebar = () => {
    ...
    const adminNavlinks = [
        ...
        { name: 'Manage Releases', path: '/admin/manage-releases', icon: CalendarIcon },
    ]
